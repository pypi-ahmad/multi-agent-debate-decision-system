...
| RAG citations missing | Turn **RAG** on. Check the Knowledge page and that `data/lancedb/` exists. |
...
Anything you pasted into the app or uploaded is **your** data. Do not attach confidential files to a public issue.
